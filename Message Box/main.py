...
def click():
    #messagebox.showinfo(title='This is an info message box',message='You are a person') #shows info when button is clicked
    #while (True):   #this will make the code run until the program is stopped, showing the message below
